...

{
  ...
  const select = {
    templateOf: {
      menuProduct: '#template-menu-product', // odnosi sie do #template-menu-product z index.html
    },
    containerOf: {
      menu: '#product-list', // #product-list w index.html
      cart: '#cart',
    },
    all: {
      menuProducts: '#product-list > .product', // #product-list w html z .product
      menuProductsActive: '#product-list > .product.active', // #product-list w html z .product i .active nadawana w js
